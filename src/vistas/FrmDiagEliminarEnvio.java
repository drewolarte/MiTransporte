...
public class FrmDiagEliminarEnvio extends javax.swing.JDialog {

    FondoPanelAcEnv fondo = new FondoPanelAcEnv();

    public FrmDiagEliminarEnvio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar Envío");

        btnAceptar.setFont(new java.awt.Font("Book Antiqua", 1, 18)); // NOI18N
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (objEnvioDB.eliminar(Integer.parseInt(this.txtId.getText()))) {
            JOptionPane.showMessageDialog(this, "El envío se eliminó con éxito.");
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Error: No se pudo eliminar el envío.");
        }
